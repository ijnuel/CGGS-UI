...
export class AdminFormComponent implements OnInit {
  ...
  formFields: FormField[] = [
    ...
    FormFieldContants.selectField("nationality", "Nationality", true, undefined, FormFieldSize.Small),
    FormFieldContants.selectField("stateOfOrigin", "State of origin", true, undefined, FormFieldSize.Small),
    FormFieldContants.selectField("originLGA", "LGA", true, undefined, FormFieldSize.Small),
    ...
    FormFieldContants.textField("residentialState", "State", true, "text", undefined, FormFieldSize.Small),
  ]
